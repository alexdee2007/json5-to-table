...
test("empty object", (t) => {
  ...
  t.deepEqual(generateTable(data, schema), new Row([{ val: undefined }, { val: undefined }]));
});
...
test("simple object", (t) => {
  ...
  t.deepEqual(generateTable(data, schema), new Row([{ val: 1 }, { val: 2 }]));
});
...
test("nested object", (t) => {
  ...
  t.deepEqual(generateTable(data, schema), new Row([{ val: 1 }, new Row([{ val: 2 }, { val: 3 }])]));
});
